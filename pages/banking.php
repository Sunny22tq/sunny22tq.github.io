                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="text-center"><img height="320" alt="" class="mw-100 ta-lz-load ta-lz-loaded" src="https://momosv3.apimienphi.com/api/QRCode?phone=<?= $value['number']; ?>&note=<?= $comment; ?>&amount=1000">
                                    </div>
                    ...
                    <div class="modal fade" id="<?= $value['id']; ?>" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="text-center"><img height="320" alt="" class="mw-100 ta-lz-load ta-lz-loaded" src="https://img.vietqr.io/image/<?= $value['bank']; ?>-<?= $value['number']; ?>-compact2.png?amount=1000&amp;accountName=<?= $value['name']; ?>&amp;addInfo=<?= $comment; ?>">
                                    </div>
                                    <div class="alert alert-primary">
                                        Vào App của ngân hàng, tìm đến phần quét mã QR-Code để thanh toán, hệ thống đã thiết
                                        lập sẵn
