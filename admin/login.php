                    ...
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            ...
                            <form method="post">
                                ...
                                <div class="text-center d-flex justify-content-between mt-4"><p>Design By <a href="https://www.facebook.com/xNgdb.xD"  style="text-decoration: none;color: blue">Nguyễn Đình Bảo</a></p></div>
                            </form>
                        </div>
                    </div>
                </div><!-- End -->
